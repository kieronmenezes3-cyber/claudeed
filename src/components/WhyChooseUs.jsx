...
const reasons = [
  ...
  },
  {
    ...
    title: 'Airbnb and HMO Experts',
    description: 'We specialise in both Airbnb short-lets and HMO property management, giving landlords the flexibility to maximise returns across all rental strategies.',
  },
  {
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="currentColor">
